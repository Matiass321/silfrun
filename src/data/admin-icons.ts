 ...
 * Admin icons.
 *
 * Lucide geometry at stroke 1.6 — heavier than the 1.25 used on the marketing
 * site, because these are read at 21px on a phone in daylight rather than at
 * rest in a dark layout. A hairline icon that looks refined on a desktop
 * showroom page is simply faint on a tab bar.
 *
 * Inlined rather than pulled from a package: the admin ships no JavaScript, so
 * there is nothing to hydrate an icon component with, and a dozen glyphs do
...
export const ADMIN_ICONS: Record<string, string> = {
  today: svg('<path d="M3 12h4l3 8 4-16 3 8h4"/>'),

  visits: svg('<path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="m9 14 2 2 4-4"/>'),
  ...
  stats: svg('<path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="M18 17V9M13 17V5M8 17v-3"/>'),
  ...
  image: svg('<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-4.35-4.35a2 2 0 0 0-2.83 0L4 20"/>'),
  ...
  /** WhatsApp keeps its own glyph — recognition is the point. */
  trash: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 7h16M10 11v6M14 11v6M6 7l1 12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2l1-12M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/></svg>',
